...
public class ViewMultipleRoleDispatch {
	...
	/** ComboBox allowing the user to select which role to play. */
	 ...
	 *
	 * <p> Description: Displays the Multiple Role Dispatch page, allowing a multi-role user
	 * to select which role they want to play during this session.</p>
	 *
	 * @param ps   the JavaFX Stage used for navigation
	 * @param user the current User whose roles will be displayed
	 */
