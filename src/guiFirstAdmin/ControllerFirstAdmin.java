...
public class ControllerFirstAdmin {
	...
	*/
	...
	/** Reference to the shared application database. */
	...
	*/
	 ...
	 */
	/*******
	 * <p> Method: doSetupAdmin(Stage ps, int r) </p>
	 *
	 * <p> Description: Called when the user presses the button to set up the Admin account.</p>
	 *
	 * @param ps the JavaFX Stage used for navigation
	 * @param r  the role number for the admin being set up
	 */
