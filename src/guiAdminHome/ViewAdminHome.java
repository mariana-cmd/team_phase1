...
public class ViewAdminHome {
	...
	*/
	...
	/** Label displaying the currently logged-in user's details. */
	protected static Label label_UserDetails = new Label();
	/** Button for navigating to the Account Update page. */
	...
	/** Label showing the current number of outstanding invitations. */
	protected static Label label_NumberOfInvitations =
			new Label("Number of Oustanding Invitations: x");
	/** Label showing the current total number of users. */
	...
	/** Label for the invitation section heading. */
	protected static Label label_Invitations = new Label("Send An Invitation");
	/** Label for the invitation email address field. */
	protected static Label label_InvitationEmailAddress = new Label("Email Address");
	/** Text field for entering the invitation recipient's email address. */
	...
	/** Alert displayed when the invitation email was successfully sent. */
	...
	/** Button to manage outstanding invitations. */
	protected static Button button_ManageInvitations = new Button("Manage Invitations");
	/** Button to set a one-time password for a user. */
	...
	/** Button to list all users in the system. */
	...
	/** Button to log out the current user and return to the login page. */
