...
public class ViewNewAccount {
	...
	*/
	...
	/** The invitation code linking to an email address and a role for this user. */
	...
	/** The role assigned via the invitation code. */
    protected static String theRole;
	/** The Scene used each time the New Account page is displayed. */
	...
	*/
	...
	private ViewNewAccount() {
		...
		alertInvalidPassword.setTitle("Password is Invalid");
		alertInvalidPassword.setContentText("Try another password.");
	 ...
	 * @param x		The location from the left edge (x axis)
	 * @param y		The location from the top (y axis)
	 * @param e		Whether the field is editable
	 */
