...
public class ViewUserLogin {
	...
	/** Alert displayed when the username or password is incorrect. */
	protected static Alert alertUsernamePasswordError = new Alert(AlertType.INFORMATION);

	/** Text field for the username entered by the user. */
	protected static TextField text_Username = new TextField();
	/** Password field for the password entered by the user. */
	...
	/** The Scene used each time the User Login page is displayed. */
	 ...
	 *
	 * <p> Description: Displays the User Login page. Sets up the GUI on first call
	 * and resets the input fields on each subsequent call.</p>
	 *
