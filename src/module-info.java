...
module FoundationsSP26 {
	...
	// Required by mariana branch's test infrastructure
	...
	// Staff discussion features (mariana branch)
	opens guiStaffAllPosts           to javafx.graphics, javafx.fxml;
	opens guiStaffCreatePost         to javafx.graphics, javafx.fxml;
	opens guiStaffCreateReply        to javafx.graphics, javafx.fxml;
	opens guiStaffDeletePosts        to javafx.graphics, javafx.fxml;
	opens guiStaffMyPosts            to javafx.graphics, javafx.fxml;
	opens guiStaffUpdatePosts        to javafx.graphics, javafx.fxml;
	opens guiStaffViewPost           to javafx.graphics, javafx.fxml;
	opens guiGradePosts              to javafx.graphics, javafx.fxml;

	// Staff request feature (staff-request branch)
